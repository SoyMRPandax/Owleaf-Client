...
class Login {
    ...
    async getMicrosoft() {
        console.log('Iniciando el inicio de sesión de Microsoft...');
    ...
    async getCrack() {
        console.log('Iniciando el inicio de sesión sin conexión...');
        let popupLogin = new popup();
        ...
        connectOffline.addEventListener('click', async () => {
            ...
            if (emailOffline.value.match(/ /g)) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'Tu Nombre No Tiene Que Tener d\'Espacios.',
                    options: true
                });
                return;
            }
    ...
    async getAZauth() {
        console.log('Iniciando el inicio de sesión AZauth...');
